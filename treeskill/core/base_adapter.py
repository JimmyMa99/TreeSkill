...
from treeskill.core.abc import ModelAdapter, OptimizablePrompt, TextualGradient, Experience
from treeskill.core.gradient import SimpleGradient, MultimodalGradient
...
class BaseModelAdapter(ModelAdapter):
    ...
    def validate_prompt(self, prompt: OptimizablePrompt) -> List[str]:
        ...
        from treeskill.core.prompts import MultimodalPrompt
