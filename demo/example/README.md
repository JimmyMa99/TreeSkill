...
这个目录包含一套complete的Config模版，帮你从零跑起 treeskill。
...
metadata:
  version: "1.0"                    # treeskill 扩展：Version号
  target: "更像真人说话"             # treeskill 扩展：优化方向
---
